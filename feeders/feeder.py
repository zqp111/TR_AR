...
class Feeder(Dataset):
    def __init__(self, data_path, label_path,
                 ...
                 use_gauss=True, gauss_mu=0, gauss_sigma=0.02, short=False):
        """
    ...
    def __getitem__(self, index):
        ...
        if self.use_gauss:
            gauss_noise = np.random.normal(self.gauss_mu, self.gauss_sigma, data_numpy.shape)
            data_numpy = data_numpy + gauss_noise


        if self.short:
            data_numpy = data_numpy[:, :30]
