...
from xp_att.utils.relative_deberta import DisentangledSelfAttention
from xp_att.utils.relative_local_deberta import DisentangledLocalSelfAttention
from xp_att.utils.position_encoding import PositionalEncoding
import random
...
class TransformerEncoderLayer(nn.Module):
    ...
    def __init__(
        ...
        if local_layer:
            ...
            self.src_src_att = DisentangledLocalSelfAttention(opts, size, num_heads, window_size=self.window_size, spatial_attn=spatial_attn)
        else:
