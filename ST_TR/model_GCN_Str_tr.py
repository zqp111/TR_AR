...
from ST_TR.GCN_Str import MuiltKernelGTCN_
from ST_TR.GCN_tr_new import MuiltKernelGTCN_tr
...
class Model(nn.Module):
    def __init__(self, n_class, graph, kernel_num, in_channels, edge_weight, lamda, graph_arg={}):
        ...
        self.backBone4 = MuiltKernelGTCN_tr(64, 64, self.A, True, kernel_num, (t_kernel, kernel_size), edge_weight, lamda)
        self.backBone5 = MuiltKernelGTCN_tr(64, 128, self.A, True, kernel_num, (t_kernel, kernel_size), edge_weight, lamda, stride=2)
        self.backBone6 = MuiltKernelGTCN_tr(128, 128, self.A, True, kernel_num, (t_kernel, kernel_size), edge_weight, lamda)
        self.backBone7 = MuiltKernelGTCN_tr(128, 128, self.A, True, kernel_num, (t_kernel, kernel_size), edge_weight, lamda)
        self.backBone8 = MuiltKernelGTCN_tr(128, 256, self.A, True, kernel_num, (t_kernel, kernel_size), edge_weight, lamda, stride=2)
        self.backBone9 = MuiltKernelGTCN_tr(256, 256, self.A, True, kernel_num, (t_kernel, kernel_size), edge_weight, lamda)
        self.backBone10 = MuiltKernelGTCN_tr(256, 256, self.A, True, kernel_num, (t_kernel, kernel_size), edge_weight, lamda)
        # ))
