...
class Model(nn.Module):
    def __init__(self,
        ...
        self.backBone2 = MuiltKernelGTCN_(32, 64, self.A, True, kernel_num, (t_kernel, kernel_size), edge_weight, lamda, stride=3)
        ...
        self.pos_embedding = nn.Parameter(torch.randn(1, 100 + 1, encode_size))
